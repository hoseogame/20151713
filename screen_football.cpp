...
int CScreen_football::g_nScreenIndex = 0;
HANDLE CScreen_football::g_hScreen[] = { 0 };

CScreen_football::CScreen_football()
{
	ScreenInit();
}


void CScreen_football::ScreenInit()
{
...
void CScreen_football::ScreenFlipping()
{
	Sleep(10);
...
void CScreen_football::ScreenClear()
{
	COORD Coor = { 0, 0 };
	DWORD dw;
...
void CScreen_football::ScreenRelease()
{
...
void CScreen_football::ScreenPrint(int x, int y, char *string)
{
	DWORD dw;
...
// 1 ~ 15 까지 색상 설정 가능
void CScreen_football::SetColor(unsigned short color)
{
	SetConsoleTextAttribute(g_hScreen[g_nScreenIndex], color);
}

void CScreen_football::InitScreen()
{
	ScreenPrint(0, 0, "┏━━━━━━━━━━━━━━━━━━━━━┓");
	ScreenPrint(0, 1, "┃                                          ┃");
	ScreenPrint(0, 2, "┃             □━━━□                   ┃");
...
void CScreen_football::ReadyScreen(int* g_nStage)
{
	char string[100];
...
void CScreen_football::BackScreen(int* g_nStage, STAGE_INFO *g_sStageInfo, clock_t *g_GameStartTime)
{
	char string[100];
...
void CScreen_football::GoalMessage(int nX, int nY)
{
...
void CScreen_football::SuccessScreen()
{
	ScreenPrint(0, 0, "┏━━━━━━━━━━━━━━━━━━━━━┓");
	ScreenPrint(0, 1, "┃                                          ┃");
	ScreenPrint(0, 2, "┃                                          ┃");
...
void CScreen_football::FailureScreen()
{
	ScreenPrint(0, 0, "┏━━━━━━━━━━━━━━━━━━━━━┓");
	ScreenPrint(0, 1, "┃                                          ┃");
	ScreenPrint(0, 2, "┃                                          ┃");
...
void CScreen_football::ResultScreen(int* g_nStage)
{
	char string[100];
	ScreenPrint(0, 0, "┏━━━━━━━━━━━━━━━━━━━━━┓");
	ScreenPrint(0, 1, "┃                                          ┃");
